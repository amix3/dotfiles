...
settings['display-scale-factor'] = 1.5
...
settings['default-style'] = [[\fnSource Sans Pro\b1\bord2\shad0\fs30\c&HE3E3E3&\3c&H2D2D2D&]]
...
settings['chapter-marker-before-style'] = [[\c&HE3E3E3&]]
...
settings['animation-duration'] = 0.333
